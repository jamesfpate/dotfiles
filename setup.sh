...
devbox global add _1password git go-task jq lsd neovim oh-my-posh python@3.13 stow zellij nodejs basedpyright lua-language-server gopls nodePackages.typescript-language-server
#non mac
